...
# Comparando com funções
def nome_complet(nome, sobrenome):
    return nome.strip().title() + ' ' + sobrenome.strip().title()

print(nome_complet('felipe ', 'guedes'))
...
testando = lambda nome: 'Meu nome é ' + nome 
print(testando("Felipe"))