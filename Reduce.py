...
A função reduce(), funciona da seguite forma:
...
Ou seja, em cada passo ela aplica a função passando com o primeiro argumento o resultado da aplicação anteior. No final, reduce() irá retornar o resultado final.
...
# Para utilizaar o reduce() nós precisamos de uma função que receba dois parâmetros
